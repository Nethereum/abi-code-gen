...
namespace Tutorials
{
   public class MultiplicationService
   {
        ...
        public static  async Task<string> DeployContractAsync(Web3.Web3 web3, string addressFrom, BigInteger multiplier, HexBigInteger gas = null, HexBigInteger valueAmount = null) 
        {
            return await web3.Eth.DeployContract.SendRequestAsync(ABI, BYTE_CODE, addressFrom, gas, valueAmount , multiplier);
        }

        private Contract contract;

        public MultiplicationService(Web3.Web3 web3, string address)
        {
            this.web3 = web3;
        ...
        public async Task<BigInteger> MultiplyAsyncCall(BigInteger a) {
